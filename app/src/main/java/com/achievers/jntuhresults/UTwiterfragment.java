...
public class UTwiterfragment extends Fragment {
    SwipeRefreshLayout swipeRefreshLayout;
    WebView webView;
    public UTwiterfragment()
    {
        //empty constructor
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate (R.layout.fragment_utwiter,container,false);
       // swipeRefreshLayout = (SwipeRefreshLayout)view.findViewById(R.id.swipe_messages);
        ...
        webView.loadUrl("file:///android_asset/twiterindex.html");
